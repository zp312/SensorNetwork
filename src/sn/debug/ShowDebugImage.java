...
public class ShowDebugImage {

	private static int _saveCount = 0;

	static class ImagePanel extends JPanel implements KeyListener,
			MouseListener {
	...
	public ShowDebugImage(String name, Image img, int[][] meta) {
	...
	public ShowDebugImage(String name, Image img) {
		this(name, img, null);
	}
