...
public class GrahamScan {
	...
	public static class YCompare implements Comparator<Point2D> {
		@Override
	...
	public static class PolarComparator implements Comparator {
		...
		/**
		 * Compares object o1 to object o2. This method returns a negative value
		 * if o1 lies to the left of o2 with respect to the pivot p0.
		 * 
		...
		public int compare(Object o1, Object o2) {
			...
			double d = ((p2.getX() - p0.getX()) * (p1.getY() - p0.getY()) - (p1
					.getX() - p0.getX()) * (p2.getY() - p0.getY()));
	...
	public static void main(String[] args) {
		Point2D[] pts = { new Point2D.Double(1, 1), new Point2D.Double(2, 2),
				new Point2D.Double(3, 3) };

		GrahamScan gs = new GrahamScan(pts);

		List<Point2D> hullPts = gs.getList();
